...
export default function ResponsiveContainer() {
  ...
  return (
    <>
      <Head>
        <title>Мцхета - лучший ресторан грузинской кухни в Москве</title>
        <meta
          name='description'
          content='Новый официальный сайт грузинского ресторана с живой музыкой. Мы представляем Вам широкий ассортимент национальных блюд, высокое качество, большие порции и низкие цены.'
        />
        <meta
          name='keywords'
          content='лучшие грузинские рестораны топ ресторанов москвы'
        />
        <meta name='viewport' content='width=device-width, initial-scale=1' />
        <meta
          name='google-site-verification'
          content='9XZMxBvsruPlp5ZcXwdWrcrvlrEjCiMCpnthiavzpJQ'
        />
        <meta name='yandex-verification' content='d58b1a69a6f62ce7' />
        <link rel='icon' href='/favicon.ico' />
      </Head>
